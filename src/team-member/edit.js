...
function Edit( {
	...
	const addNewSocialItem = () => {
		setAttributes( {
			socialLinks: [ ...socialLinks, { icon: 'linkedin', link: '' } ],
		} );
	...
	return (
		<>
			...
			<div { ...useBlockProps() }>
				{ url && (
					<div
						className={ `wp-block-limon-team-member-img${
				...
				<div className="wp-block-limon-team-member-social-links">
					<ul>
						<DndContext
							sensors={ sensors }
						...
						{ isSelected && (
							<li className="wp-block-limon-team-member-add-icon-li">
								<Tooltip
									text={ __(
										'Add Social Link',
										'team-members'
				...
				{ selectedLink !== undefined && (
					<div className="wp-block-limon-team-member-link-form">
						<TextControl
